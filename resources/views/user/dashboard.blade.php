        ...
        <div class="mr-4 bg-[#FFFFFF] rounded-lg p-5">
            <div class="grid grid-cols-3 gap-4">
                <div class="bg-blue-100 p-4 rounded-lg">
                    <h2 class="font-semibold">Jumlah Meminjam</h2>
                    <p class="text-lg font-bold">{{$hitungPinjam}}</p>
                </div>
                <div class="bg-blue-100 p-4 rounded-lg">
                    <h2 class="font-semibold">Terakhir Meminjam</h2>
                    <p class="text-lg font-bold">{{$terakhirPinjam}}</p>
                </div>
                <div class="bg-blue-100 p-4 rounded-lg">
                    <h2 class="font-semibold">Buku Terakhir</h2>
                    <p class="text-lg font-bold">{{$bukuTerakhir}}</p>
                </div>
            </div>
        </div>
    </section>
